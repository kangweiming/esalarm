jQuery().ready(function(){
	...
	jQuery("#search").click(function(){
		...
		jQuery("#triggerListForm").submit();
	});
	
	jQuery("#reset").click(function(){
		jQuery("#triggerName").val("");
		jQuery("#triggerGroup").val("");
		jQuery("#triggerStatus").val("");
...
function pauseTrigger(optName,optGroup){
	jQuery('#triggerListForm').attr("action", "triggerOpt");
	jQuery('#opt').val("pauseTrigger");
	jQuery('#optName').val(optName);
	jQuery('#optGroup').val(optGroup);
	jQuery('#triggerListForm').submit();
}

function resumeTrigger(optName,optGroup){
	jQuery('#triggerListForm').attr("action", "triggerOpt");
	jQuery('#opt').val("resumeTrigger");
	jQuery('#optName').val(optName);
	jQuery('#optGroup').val(optGroup);
	jQuery('#triggerListForm').submit();
}
